...
// asset-input/lambda/createProduct/index.ts
...
// asset-input/node_modules/uuid/dist/esm/stringify.js
var byteToHex = [];
for (let i = 0; i < 256; ++i) {
...
// asset-input/node_modules/uuid/dist/esm/rng.js
...
// asset-input/node_modules/uuid/dist/esm/native.js
var import_crypto2 = require("crypto");
var native_default = { randomUUID: import_crypto2.randomUUID };

// asset-input/node_modules/uuid/dist/esm/v4.js
    ...
    try {
      ...
      if (transactionError.name === "TransactionCanceledException") {
        ...
        return createResponse(409, {
          ...
          error: process.env.IS_OFFLINE ? `Transaction cancelled: ${transactionError.message}` : "Transaction failed"
        });
      }
